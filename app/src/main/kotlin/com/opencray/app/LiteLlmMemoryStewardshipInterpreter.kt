...
internal class LiteLlmMemoryStewardshipInterpreter(
  ...
  private fun buildPrompt(request: MemoryStewardshipRequest): String = buildString {
    ...
    appendLine("- Allowed action values: refresh_record_with_candidate, reaffirm_record, resolve_record, supersede_record_with_candidate, drop_candidate.")
    ...
    appendLine("- Only use refresh_record_with_candidate or supersede_record_with_candidate when the record and candidate clearly refer to the same underlying memory topic.")
