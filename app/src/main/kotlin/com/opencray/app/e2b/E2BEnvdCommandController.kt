...
import com.opencray.app.E2BSandboxActivityTracker
...
import com.opencray.app.ResolvedSandboxSettings
import com.opencray.app.SandboxCommandBackendCapabilities
import com.opencray.app.SandboxCommandBackendSelection
import com.opencray.app.SandboxExecutionTraceMetadata
import com.opencray.app.SandboxProviderId
...
internal data class NativeCommandAttemptContext(
...
internal class E2BMinimalNativeForegroundCommandProcessRunner(
...
internal class E2BMinimalProtocolManagedProcessControllerFactory(
  private val workspaceRootProvider: () -> Path,
  private val settingsProvider: () -> ResolvedSandboxSettings,
  private val sessionStore: E2BSandboxSessionStore,
  private val activeSessionProvider: () -> E2BSandboxSessionSnapshot?,
...
internal enum class NativeManagedCommandStreamMode {
  START,
  CONNECT,
}

internal class E2BMinimalNativeManagedCommandController(
