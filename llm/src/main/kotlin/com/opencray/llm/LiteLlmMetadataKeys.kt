...
object LiteLlmMetadataKeys {
  ...
  const val STREAM_REQUESTED: String = "streamRequested"
  const val STREAM_TRANSPORT_MODE: String = "streamTransportMode"
  const val STREAM_DOWNGRADE_REASON: String = "streamDowngradeReason"
