...
class ToolCapabilityClassifierTest {
  ...
  fun classifiesFileAndNetworkToolsConsistently() {
    ...
    assertEquals(PolicyToolClass.READ_FILE, classifier.classifyPolicyToolClass("sandbox_session_info"))
    ...
    assertEquals("read_sandbox_session", classifier.classifyCapabilityKind("sandbox_session_info"))
