...
/**
 * Default Python runtime backend for host environments where a local `python` executable is
 * available. This preserves the current `python -m python_runner.runner ...` behavior while
 * Android-specific code migrates to an embedded runtime implementation.
 */
class HostProcessPythonRuntime(
