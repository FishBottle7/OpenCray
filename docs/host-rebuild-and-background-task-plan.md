...
- on-device validation of remote Binder control with both target processes alive, followed by detached-process kill/recreate and managed-process reconnect/repair verification
