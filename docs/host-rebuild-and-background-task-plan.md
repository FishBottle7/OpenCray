...
- restore the unrelated stale UI resource-id AndroidTest baseline, execute the checked-in remote Binder and detached-process kill/recreate instrumentation harness, then perform provider-specific managed-process reconnect/repair verification on Android
